<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CatagoryUI" %>
...
<body style="height: 73px">
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                <td class="auto-style2"><strong>Category Setup</strong></td>
            </tr>
        </table>
                    ...
                    <table class="auto-style23">
                        ...
                        <tr>
                            <td class="auto-style60"><strong>
                                <asp:LinkButton ID="categorySetupLinkButton" runat="server" CssClass="auto-style59" OnClick="categorySetupLinkButton_OnClick">Category Setup</asp:LinkButton>
                                </strong></td>
                        </tr>
                        <tr>
                            <td class="auto-style60"><strong>
                    ...
                    <table class="auto-style27">
                        ...
                        <tr>
                            ...
                            <td class="auto-style51"><strong>
                                <asp:GridView ID="catagoryListGridView" runat="server" CellPadding="4" CssClass="auto-style47" ForeColor="#333333" GridLines="None" Height="216px" Width="232px" AutoGenerateColumns="False">
